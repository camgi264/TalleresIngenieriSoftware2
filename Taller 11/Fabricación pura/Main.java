...
public class Main {
    public static void main(String[] args) {
        ...
        Cliente cliente = fabrica.crearCliente("Camila", "Cr 27");
        Pedido pedido = fabrica.crearPedido(1, new Date(), cliente);
        Producto producto1 = fabrica.crearProducto("Celular", 1000000, 2);
        Producto producto2 = fabrica.crearProducto("Teclado", 100000, 1);
